...
--
-- Database: `u701929732_dementiabn`
--
...
CREATE TABLE `missing_pt` (
  ...
  `mp_reporter_name` varchar(100) NOT NULL,
  `mp_reporter_contact_no` varchar(100) NOT NULL,
  `mp_reporter_email` varchar(100) NOT NULL,
...
--
-- Dumping data for table `missing_pt`
--

INSERT INTO `missing_pt` (`mp_id`, `pcd_id`, `pt_id`, `mp_reporter_name`, `mp_reporter_contact_no`, `mp_reporter_email`, `mp_latitude`, `mp_longitude`, `mp_status`, `mp_date`, `mp_remark`) VALUES
(6, 0, 22, '', '', '', '4.8857088', '114.8452864', 'spotted', '2024-06-24 00:00:00', 'd'),
(7, 0, 22, '', '', '', '4.8857088', '114.8452864', 'spotted', '2024-06-24 21:51:08', 'd'),
(8, 0, 22, '', '', '', '4.8857088', '114.8452864', 'spotted', '2024-06-24 22:01:44', 'f'),
(9, 32, 22, '', '', '', '4.8857088', '114.8452864', 'spotted', '2024-06-24 22:02:37', 'd'),
(10, 32, 22, '', '', '', '4.8857088', '114.8452864', 'spotted', '2024-06-24 23:17:50', 'found this person at KIGS');
...
(22, 0, 32, '333333', 'kamis bin jumat', '2024-05-30', 2, 'late', 'atuk', 'yrdy', 'test', 'asset/qr/22_file_501a32f89ac6da60b134ced0df2120d1.png', 'asset/photo/22.png');
...
(17, 32, 33, 5, 'unset', '2024-05-20'),
(18, 32, 35, 6, 'set', '2024-05-27'),
(19, 32, 33, 6, 'unset', '2024-06-18'),
(20, 32, 35, 5, 'set', '2024-06-18');
...
--
ALTER TABLE `missing_pt`
  MODIFY `mp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `pc_sc`
  MODIFY `pcsc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
