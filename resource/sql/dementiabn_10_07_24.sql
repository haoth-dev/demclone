...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2024 at 07:38 PM
...
(121, 'event', 'validation failed when  attempt to update password', '2024-07-08 22:23:27', 32),
(122, 'event', 'validation failed when  attempt to update password', '2024-07-08 22:24:50', 32),
(123, 'event', 'validation failed when reiza.sulaiman@gmail.com attempt to update password', '2024-07-08 22:25:47', 32),
(124, 'event', 'validation failed when reiza.sulaiman@gmail.com attempt to update password', '2024-07-09 00:49:28', 32),
(125, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 00:49:50', 32),
(126, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:06:58', 32),
(127, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:08:07', 32),
(128, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:10:22', 32),
(129, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:11:03', 32),
(130, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:11:51', 32),
(131, 'event', 'validation failed when reiza.sulaiman@gmail.com attempt to update password', '2024-07-09 01:14:56', 32),
(132, 'event', 'validation failed when reiza.sulaiman@gmail.com attempt to update password', '2024-07-09 01:19:06', 32),
(133, 'event', 'validation failed when reiza.sulaiman@gmail.com attempt to update password', '2024-07-09 01:21:15', 32),
(134, 'event', 'reiza.sulaiman@gmail.com successfully updated password', '2024-07-09 01:21:24', 32),
(135, 'event', 'alifjulaihi.mp@gmail.com successfully update kamis bin jumat data', '2024-07-09 01:39:09', 32),
(136, 'event', 'admin successfully added new PWD!', '2024-07-09 23:22:55', 34),
(137, 'event', 'alifjulaihi.mp@gmail.com successfully update kamis bin jumat data', '2024-07-10 00:49:50', 32),
(138, 'event', 'alifjulaihi.mp@gmail.com successfully update kamis bin jumat data', '2024-07-10 00:52:11', 32),
(139, 'event', 'Admin successfully update kamis bin sabtu data', '2024-07-10 01:19:55', 34),
(140, 'event', 'Admin successfully update kamis bin sabtu data', '2024-07-10 01:28:06', 34),
(141, 'event', 'Admin successfully update kamis bin sabtu data', '2024-07-10 01:28:42', 34);
...
--
ALTER TABLE `admin_log`
  MODIFY `al_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
...
--
ALTER TABLE `login`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `pc_detail`
  MODIFY `pcd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
