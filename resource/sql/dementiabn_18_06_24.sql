...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2024 at 06:12 AM
...
INSERT INTO `patient` (`pt_id`, `pcm_id`, `pcd_id`, `pt_ic`, `pt_name`, `pt_dob`, `pt_height`, `pt_weight`, `dt_id`, `pt_relationship`, `pt_location`, `pt_remark`, `pt_qr_path`) VALUES
