...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2024 at 03:01 AM
...
--
-- Dumping data for table `pc_meds`
--

INSERT INTO `pc_meds` (`pcm_id`, `pcd_id`, `pt_id`, `meds_id`, `pcm_qty`, `pcm_unit`, `pcm_freq`, `pcm_remark`, `pcm_date`) VALUES
(6, 32, 5, 3, 1, 'tablet', 3, '32', '2024-06-09'),
(7, 32, 6, 3, 1, 'tablet', 5, 'bari ngantuk', '2024-06-09'),
(8, 32, 6, 3, 500, 'ml', 3, 'makan bila perlu, side-effect:bleh ngantuk. elakkan driving or handling machine', '2024-06-09');
...
--
ALTER TABLE `pc_meds`
  MODIFY `pcm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
