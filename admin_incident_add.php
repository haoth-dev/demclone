    ...
    <form id="contactForm" method='post'>
        ...
        ?>
            <div class="input-group mb-3">
                <label class="input-group-text" for="inputGroupSelect01">Caller</label>
                <select class="form-select" id="inputGroupSelect01" name="inc_caller">
                    <?php
                    foreach ($careList as $value) {
                    ?>
                        <option value="<?php echo $value['pcd_email'] ?>"><?php echo  get_email_prefix($value['pcd_email']); ?></option>
                    <?php
